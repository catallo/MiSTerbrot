...
| `O[55:54]`| Resolution (320×240 / 640×240 / 320×480i / 640×480i) — unified selector; replaces the former O[22]+O[53] pair.  640×480i renders into the DDR3 framebuffer (`rtl/fb_ddr3.v`, `docs/TRACKB_DESIGN.md`); Buffer option ignored there (always double) |
